...
export const homeObjectFour = {
    ...
    lightText: true,
    lightTextDes: true,
    topLine: 'Join SafetyDepositBlock Today',
    headline: 'Create an Account Fast and Receive Instant Value',
    description: 'Through tbe power of decentralization, community, and innovation, SafetyDepositBlock will change how we work on projects and launch the companies of tomorrow, today.',
